$.fn.pageMe = function(opts){
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="prev_link" title="'+settings.prevText+'"><i class="icon-keyboard_arrow_left prefix"></i></a></li>').appendTo(pager);
    }
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="next_link"  title="'+settings.nextText+'"><i class="icon-keyboard_arrow_right"></i></a></li>').appendTo(pager);
    }

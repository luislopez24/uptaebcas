      ...
      <div class="row">
       ...
       <div class="col s12 m12">
        <div class="white-text card-panel blue darken-2">
          <center><span class="card-title"><h7>Dinero ingresado</h7></span></center>
        </div>
      </div>
      <br>
  ...
  var grafico = new Chart(ctx, {
    ...
    data: {
                         labels: ["Enero",
                                  ...
                                  "Diciembre"],
        datasets: [{
            label: '# Dinero ingresado en los 12 meses del año ' + year,
                           data: [enero,
                                  febrero,
                                  marzo,
                                  abril,
...
<script type="text/javascript">
    ...
    $('#pdf').click(function(e){
        ...
        if (name == null) { name = 'Dinero ingresado a CAS'; }

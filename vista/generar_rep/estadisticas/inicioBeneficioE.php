      ...
      <div class="row">
       ...
       <div class="col s12 m12">
        <div class="white-text card-panel blue darken-2">
          <center><span class="card-title"><h7>Beneficios entregados</h7></span></center>
        </div>
      </div>
      <br>
  ...
  var grafico = new Chart(ctx, {
    ...
    data: { 
                         labels: ["Enero",
                                  ...
                                  "Diciembre"],
        datasets: [{
            label: '# Entrega de beneficios en los 12 meses del año ' + year,
                           data: [enero,
                                  febrero,
                                  marzo,
                                  abril,
...
<script type="text/javascript">
    ...
    $('#pdf').click(function(e){
        ...
        if (name == null) { name = 'Beneficios entregados CAS'; }

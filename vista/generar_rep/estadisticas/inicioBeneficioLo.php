  ...
  <main>
    ...
    <section class="section">
      <div class="row">
       ...
       <div class="col s12 m12">
        <div class="white-text card-panel blue darken-2">
          <center><span class="card-title"><h7>Beneficiarios logueados</h7></span></center>
        </div>
      </div>
      <br>
           ...
           <div class="col s12 m12">
            ...
            <div class="box-body">
              ...
              <div class="chart" id="cas">
                <canvas id="grafico" name="grafico" style="height:230px"></canvas>
              </div>
      ...
      <div class="card-action">
        <center>
          <a data-position="bottom" data-tooltip="Exportar a PDF" class="tooltipped" href="#"  id="pdf" name="pdf">PDF</a> 
          </form>
        </center>
      </div>
    </div>
  ...
  var grafico = new Chart(ctx, {
    ...
    data: {
                         labels: ["Enero",
                                  ...
                                  "Diciembre"],
        datasets: [{
            label: '# Beneficiarios logueados en los 12 meses del año ' + year,
                           data: [enero,
                                  febrero,
                                  marzo,
                                  abril,
...
<script type="text/javascript">
    ...
    $('#pdf').click(function(e){
        ...
        if (name == null) { name = 'Beneficiarios logueados a CAS'; }

          ...
          <div style="margin-left: 20px!important; margin-right: 20px;">
            ...
            <table class="highlight">
              <tbody>    
                ...
                <tr onClick="document.location.href='?url=notificacion&opcion=archivadosBuzon'" style="background: #EEEEEE; border: none!important;">
          ...
          <div  style="margin-left: 20px!important; margin-right: 20px;">
              ...
              <tbody>
                <tr>
                  <td>
                    ...
                    <form action="?url=notificacion&opcion=eliminarMsj&ruta=archivadosBuzon.php&accion=buzon" method="POST" id="eliminarMsj" name="eliminarMsj">
            ...
            <table id="tabla" class="highlight" > 
              <tbody>    
                ...
                <?php foreach ($mensajesArchi as $msj): 
                ...
                <tbody >
                 <tr class="nose" <?php if($msj["leido"]=='1'){ ?> style="background: #EEEEEE; border: none!important" <?php } ?>
                  ...
                  <td ><i onClick="document.location.href='?url=notificacion&opcion=actualizarFavorito&idMensaje=<?php echo $msj["idBuzon"];?>&ruta=archivadosBuzon.php&setFav=1'" class="waves-effect waves-block waves-light icon-star_border"></i></td>
                  <?php }else { ?>
                  <td><i onClick="document.location.href='?url=notificacion&opcion=actualizarFavorito&idMensaje=<?php echo $msj["idBuzon"];?>&ruta=archivadosBuzon.php&setFav=0'"  class="waves-effect waves-block waves-light icon-star"></i></td>
                  <?php } ?>
                  ...
                  <td onClick="document.location.href='?url=notificacion&opcion=verMensajeBuzon&idMensaje=<?php echo $msj["idBuzon"];?>&direc=archi&view=0'"  class="waves-effect waves-block waves-light"><?php echo $resultado; ?></td> 

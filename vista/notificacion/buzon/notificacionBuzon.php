          ...
          <div style="margin-left: 20px!important; margin-right: 20px;">
            ...
            <table class="highlight">
              <tbody>    
                ...
                <tr onClick="document.location.href='?url=notificacion&opcion=notificacionBuzon'" style="background: #EEEEEE; border: none!important;">
              ...
              <tbody>
                <tr>
                  <td>
                    ...
                    <form action="?url=notificacion&opcion=eliminarMsj&ruta=notificacionBuzon.php&accion=buzon" method="POST" id="eliminarMsj" name="eliminarMsj">
    
                    <a href="#" onclick="eliminarMensajes();" data-position="bottom" data-tooltip="Eliminar notificaciones seleccionadas" class="btn tooltipped waves-effect waves-light red darken-2 white-text btn-small" style="border-radius: 3em;"><i class="icon-delete prefix"></i></a>
              ...
              <tbody>    
                ...
                <tbody >
                 <tr class="nose" <?php if($msj["leido"]=='1'){ ?> style="background: #EEEEEE; border: none!important" <?php } ?>
                  ...
                  <?php if($msj["foto_icono"] == "1"){ ?>                  
                  <td class="priority-2"><span class="icon-hourglass_empty prefix" id="two"></span></td>
                  
                  <?php } if($msj["foto_icono"] == "2"){ ?>
                  <td><span class="icon-today prefix" id="three"></span></td>
                  
                  <?php } if($msj["foto_icono"] == "3"){ ?>
                  <td><span class="icon-settings prefix" id="four"></span></td>
                  <?php } ?>

                  <?php if($msj["idEmisor"] == "0"){ ?>
                  <td><div style="margin-top: 0px">System CAS</div></td>
                  <?php } ?>

                  <td class="priority-2"><?php echo $msj["asunto"];?> </td>
                  ...
                  if ($n_s > 15) {
                   ...
                   <td onClick="document.location.href='?url=notificacion&opcion=verMensajeBuzon&idMensaje=<?php echo $msj["idBuzon"];?>&direc=noti&view=1'"  class="waves-effect waves-block waves-light"><?php echo $resultado; ?></td> 
                  <td><i class="icon-hourglass_empty"></i></td>
                  <td><?php if ($Mensajefecha == $date) { echo  "Hoy a las ".$Mensajehora; } else { echo "El ".$Mensajefecha." a las ".$Mensajehora;} ?></td>

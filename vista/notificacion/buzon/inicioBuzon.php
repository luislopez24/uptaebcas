          ...
          <div style="margin-left: 20px!important; margin-right: 20px;">
            ...
            <table class="highlight">
              <tbody>    
                ...
                <tr onClick="document.location.href='?url=notificacion&opcion=buzon'" style="background: #EEEEEE; border: none!important;">
          ...
          <div  style="margin-left: 20px!important; margin-right: 20px;">
              ...
              <tbody>
                <tr>
                  <td>
                    ...
                    <form action="?url=notificacion&opcion=eliminarMsj&ruta=inicioBuzon.php&accion=buzon" method="POST" id="eliminarMsj" name="eliminarMsj">

                    <a href="#" onclick="document.getElementById('eliminarMsj').action='?url=notificacion&opcion=actualizarArchivar&ruta=inicioBuzon.php'; document.eliminarMsj.submit();" data-position="bottom" data-tooltip="Archivar mensajes seleccionados" class="btn tooltipped waves-effect waves-light purple darken-2 white-text btn-small" style="border-radius: 3em;"><i class="icon-archive prefix"></i></a>
            ...
            <table id="tabla" class="highlight" > 
              <tbody>    
                ...
                <?php foreach ($mensajesBuzon as $msj): 
                ...
                <tbody >
                 <tr class="nose" <?php if($msj["leido"]=='1'){ ?> style="background: #EEEEEE; border: none!important" <?php } ?>
                  ...
                  <td data-position="bottom" data-tooltip="Añadir a favoritos"  class="tooltipped"><i onClick="document.location.href='?url=notificacion&opcion=actualizarFavorito&idMensaje=<?php echo $msj["idBuzon"];?>&ruta=inicioBuzon.php&setFav=1'" class="waves-effect waves-block waves-light icon-star_border"></i></td>
                  <?php }else { ?>
                  <td data-position="bottom" data-tooltip="Quitar de favoritos"  class="tooltipped"><i onClick="document.location.href='?url=notificacion&opcion=actualizarFavorito&idMensaje=<?php echo $msj["idBuzon"];?>&ruta=inicioBuzon.php&setFav=0'"  class="waves-effect waves-block waves-light icon-star"></i></td>
                  <?php } ?>
                  ...
                  <td onClick="document.location.href='?url=notificacion&opcion=verMensajeBuzon&idMensaje=<?php echo $msj["idBuzon"];?>&direc=imbox&view=1'"  class="waves-effect waves-block waves-light"><?php echo $resultado; ?></td> 

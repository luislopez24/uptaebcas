          ...
          <div style="margin-left: 20px!important; margin-right: 20px;">
            ...
            <table class="highlight">
              <tbody>    
                ...
                <tr onClick="document.location.href='?url=notificacion&opcion=enviadosBuzon'" style="background: #EEEEEE; border: none!important;">
              ...
              <tbody>
                <tr>
                  <td>
                    ...
                    <form action="?url=notificacion&opcion=eliminarMsj&ruta=enviadosBuzon.php&accion=send" method="POST" id="eliminarMsj" name="eliminarMsj">
            ...
            <table id="tabla" class="highlight" > 
              <tbody>    
                ...
                <tbody>    
                 ...
                 <?php foreach ($mensajesSend as $msj): 
                  ...
                  <tr class="nose">
                    ...
                    <td>
                      <center style="margin-left: 10px!important">
                       <label>
                  ...
                  <?php $resultado = substr($msj['mensaje'], -22); ?>
                  <td align="center">
                  ...
                  <td onClick="document.location.href='?url=notificacion&opcion=verMensajeBuzon&idMensaje=<?php echo $msj["idBuzon"];?>&direc=send&view=0'"  class="waves-effect waves-block waves-light"><?php echo $resultado; ?></td> 

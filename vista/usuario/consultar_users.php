      ...
      <div class="row">
       ...
       <div class="col s12 m12">
        <div class="white-text card-panel blue darken-2">
          <center><span class="card-title"><h7>Usuarios</h7></span></center>
        </div>
      </div>
      ...
      <div class="col s12 m12"> 
        <div class="card" style="margin-left: 20px; margin-right: 20px">
          ...
          <div style="margin-left: 20px; margin-right: 20px">
            ...
            <table id="tabla" class="centered"  cellspacing="0">
             <thead>     
               <tr>
            ...
            foreach($datos as $strExec){
              ...
              if ($strExec["tipo_rol"]=='2' || $strExec["tipo_rol"] == '3' || $strExec["tipo_rol"] == '1') {
                ...
                <tbody>
                 ...
                 <tr>
                   ...
                   <td class="priority-3"><?php echo $strExec["nombreRol"]?></td>
                   <td class="priority-4"><?php echo $strExec["tcelular"]."-".$strExec["celular"]?></td>
                   <td class="priority-5"><?php echo $strExec["dependencia"]?></td>
                   <td class="priority-1">
                    <a href="?url=usuario&opcion=buscar_perfil&tipo=usuario&id=<?php echo $strExec['id_usuario']?>" data-position="bottom" data-tooltip="Consultar perfil" class="btn tooltipped waves-effect waves-light green darken-2 white-text  btn-small"><i class="icon-send"></i></a>
                  </td>

                  <?php if(isset($modificarUsuario)){ ?>
                  <td class="priority-1">
                    <a href="?url=usuario&opcion=modificar_usuario&id=<?php echo $strExec['id_usuario']?>"  data-position="bottom" data-tooltip="Modificar usuario" class="btn tooltipped waves-effect waves-light yellow darken-3 white-text btn modal-trigger btn-small"><i class="icon-settings"></i></a>
                  </td>
                  <?php } ?>
                  
                  <?php if(isset($eliminarUsuario)){ ?>
                  <td class="priority-1">
                    <a href="javascript:void(0);" onclick="eliminar('?url=usuario&opcion=eliminar_usuario&rol=<?php echo $strExec['tipo_rol']; ?>&id=<?php echo $strExec['id_usuario']?>');" data-position="bottom" data-tooltip="Eliminar usuario" class="btn tooltipped waves-effect waves-light red darken-2 white-text  btn-small"><i class="icon-delete"></i></a>
                  </td>
                  <?php } ?>
                </tr>
